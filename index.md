...
<aside style="float:right;padding: 10px;border: 1px solid rgb(205,205,205);border-top: 6px solid rgb(205,205,205,0.8);width=200;background: "><img src='/Users/jiayaoyang/Documents/Personal/Photos/jiayao.png' alt='jiayao' width: 180></aside>
...
<font color=lavendar style="font-family:monospace;text-shadow: 3px 3px 2px rgba(0, 0, 0, .3);">Jiayao Yang</font>
